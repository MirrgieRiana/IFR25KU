...
- 追加: 以下の素材アイテムを追加。
   - 「灰」
      - かまどやアタノールで入手。
   - 「硝石」
      - 砂漠およびサバンナの浅い層、鍾乳洞に鉱石が生成される。
      - 他、アタノールで入手。
- 追加: 以下の鉱石ブロックを追加。
   - 「硝石鉱石」
   - 「深層硝石鉱石」
   - 「砂岩硝石鉱石」
- 追加: 硝石・石炭／木炭・硫黄からの火薬のレシピを追加。
- 追加: 固形燃料にアタノールによるレシピを追加。
- 追加: 紅天石をアタノールで分解するレシピを追加。
- 追加: 守護の耐霊石をアタノールで分解するレシピを追加。
- 追加: 板材および木の棒からアタノールで灰を作るレシピを追加。
...
- 追加: 以下のツールアイテムを追加。
   ...
   - 「妖精のプラスチックのシャベル」
   - 「妖精のプラスチックの剣」
- 追加: 鉱石ブロック「土妖精のプラスチック鉱石」を追加。
   - 妖精の樹海のY48～128の間の空気に面していない土に極低確率で生成。

フェアリークエスト

- 変更: 全体的にレシピの入出力を変更。
- 変更: 一部のフェアリークエストの加工時間を0.5秒に減少。
- 追加: 以下のフェアリークエストを追加。
   - 「Re: Re: Re: パネッツァ氏の違法薬物所持の疑い」
   - 「シャルパの夜 ～夜空を彩るレジンの星～」
   - 「妖精の倫理について考える市民の会」
- 表示: 「非常事態」のアイコンを紙に変更。
- 表示: レシピビューワーでタイトルテキストのツールチップを表示。
