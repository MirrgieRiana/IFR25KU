...
class AttractingParticle internal constructor(
...
) : TextureSheetParticle(clientLevel, fromX, fromY, fromZ, 0.0, 0.0, 0.0) {
    ...
    class Factory(private val spriteProvider: SpriteSet) : ParticleProvider<SimpleParticleType> {
        override fun createParticle(defaultParticleType: SimpleParticleType, clientLevel: ClientLevel, d: Double, e: Double, f: Double, g: Double, h: Double, i: Double): Particle {
            val particle = AttractingParticle(clientLevel, d, e, f, g, h, i)
