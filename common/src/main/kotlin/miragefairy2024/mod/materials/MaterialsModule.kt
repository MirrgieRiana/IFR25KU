...
class MaterialCard(
    ...
    companion object {
        ...
        val PHANTOM_DROP: MaterialCard = !MaterialCard(
            ...
            foodComponentCreator = {
                FoodProperties.Builder()
                    ...
                    .effect(MobEffectInstance(MobEffects.LUCK, 20 * 60), 1.0F)
                    .alwaysEdible()
                    .build()
            },
            creator = { FoodItem(it) },
        ...
        val PHANTOM_DROP_KOHAKUTO = createKohakuto(
            ...
            PHANTOM_DROP.item,
            { it.effect(MobEffectInstance(MobEffects.REGENERATION, 20 * 30, 1), 1.0F).effect(MobEffectInstance(MobEffects.LUCK, 20 * 60, 1), 1.0F) },
        )
    }
