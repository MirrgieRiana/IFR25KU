...
open class BlockMaterialCard(
    ...
    companion object {
        ...
        val MIRAGE_LEAVES_BLOCK: BlockMaterialCard = !object : BlockMaterialCard(
            ...
            PoemList(1).poem("Archive the forgotten leaves", "喪われ、そして収集されたメメント。"),
        ...
        }.needTool(ToolType.PICKAXE, ToolLevel.STONE).tag(AURA_RESISTANT_CERAMICS_TAG).init {
        ...
        }.needTool(ToolType.PICKAXE, ToolLevel.STONE).tag(BlockTags.SLABS).tag(ItemTags.SLABS).tag(AURA_RESISTANT_CERAMIC_SLABS_TAG).init {
        ...
        val AURA_RESISTANT_CERAMIC_STAIRS: BlockMaterialCard = !object : BlockMaterialCard(
            ...
            context(ModContext) override fun initBlockStateGeneration() = Unit
            context(ModContext) override fun initModelGeneration() = Unit
        }.needTool(ToolType.PICKAXE, ToolLevel.STONE).tag(BlockTags.STAIRS).tag(ItemTags.STAIRS).tag(AURA_RESISTANT_CERAMIC_STAIRS_TAG).init {
        ...
        val RESIN_CEMENTED_DIRT_BRICKS = !BlockMaterialCard(
            ...
            MapColor.COLOR_ORANGE, 1.5F, 6.0F,
        ).sound(SoundType.MUDDY_MANGROVE_ROOTS).needTool(ToolType.PICKAXE, ToolLevel.STONE).init {
            registerShapedRecipeGeneration(item, count = 4) {
                pattern("##")
                pattern("##")
        ...
        val RESIN_CEMENTED_DIRT_BRICKS_SLAB: BlockMaterialCard = !object : BlockMaterialCard(
            ...
            context(ModContext) override fun initModelGeneration() = Unit
            context(ModContext) override fun initLootTableGeneration() = block.registerLootTableGeneration { it, _ -> it.createSlabItemTable(block()) }
        }.sound(SoundType.MUDDY_MANGROVE_ROOTS).needTool(ToolType.PICKAXE, ToolLevel.STONE).tag(BlockTags.SLABS).tag(ItemTags.SLABS).init {
        ...
        val RESIN_CEMENTED_DIRT_BRICKS_STAIRS: BlockMaterialCard = !object : BlockMaterialCard(
            ...
            context(ModContext) override fun initBlockStateGeneration() = Unit
            context(ModContext) override fun initModelGeneration() = Unit
        }.sound(SoundType.MUDDY_MANGROVE_ROOTS).needTool(ToolType.PICKAXE, ToolLevel.STONE).tag(BlockTags.STAIRS).tag(ItemTags.STAIRS).init {
