...
class HaimeviskaPlanksButtonBlockCard(configuration: WoodBlockConfiguration, private val blockSetType: () -> BlockSetType, private val parent: () -> Block) : WoodBlockCard(configuration) {
