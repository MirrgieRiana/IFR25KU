...
class HaimeviskaPlanksFenceGateBlockCard(configuration: WoodBlockConfiguration, private val woodType: () -> WoodType, private val parent: () -> Block) : WoodBlockCard(configuration) {
