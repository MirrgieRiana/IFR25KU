...
object HaimeviskaBlockCard {
    ...
    val WOOD = !WoodBlockConfiguration(
    ...
    val STRIPPED_LOG = !WoodBlockConfiguration(
    ...
    val STRIPPED_WOOD = !WoodBlockConfiguration(
    ...
    val INCISED_LOG = !WoodBlockConfiguration(
    ...
    val HOLLOW_LOG = !WoodBlockConfiguration(
    ...
    val PLANKS = !WoodBlockConfiguration(
    ...
    val SLAB = !WoodBlockConfiguration(
    ...
    val STAIRS = !WoodBlockConfiguration(
    ...
    val FENCE = !WoodBlockConfiguration(
    ...
    val FENCE_GATE = !WoodBlockConfiguration(
    ...
    val BUTTON = !WoodBlockConfiguration(
    ...
    val PRESSURE_PLATE = !WoodBlockConfiguration(
    ...
    val DOOR = !WoodBlockConfiguration(
    ...
    val TRAPDOOR = !WoodBlockConfiguration(
    ...
    val BRICKS = !WoodBlockConfiguration(
    ...
    val BRICKS_SLAB = !WoodBlockConfiguration(
    ...
    val BRICKS_STAIRS = !WoodBlockConfiguration(
