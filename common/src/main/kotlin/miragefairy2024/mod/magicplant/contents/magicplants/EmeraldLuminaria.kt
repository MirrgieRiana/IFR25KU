...
object EmeraldLuminariaCard : AbstractLuminariaCard<EmeraldLuminariaBlock>() {
    ...
    override val drops = listOf(Pair(MaterialCard.LUMINITE.item, TraitEffectKeyCard.RARE_PRODUCTION.traitEffectKey.name), Pair({ Items.EMERALD }, TraitEffectKeyCard.SPECIAL_PRODUCTION.traitEffectKey.name))
