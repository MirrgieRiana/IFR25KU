...
object TopazLuminariaCard : AbstractLuminariaCard<TopazLuminariaBlock>() {
    ...
    override val drops = listOf(HarvestNotation.CropConfiguration(MaterialCard.LUMINITE.item, null), HarvestNotation.CropConfiguration(MaterialCard.TOPAZ.item, null))
