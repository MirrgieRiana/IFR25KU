...
private fun TreeBlockConfiguration.incisedPlasticTreeLog(log: () -> TreeBlockCard) = this.logBase().block { { IncisedPlasticTreeLogBlock(it) } }.let { TreeIncisedLogBlockCard(it, log) }
