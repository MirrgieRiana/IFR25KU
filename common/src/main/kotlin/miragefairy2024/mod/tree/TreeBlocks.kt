...
private fun TreeBlockConfiguration.drippingLog(log: () -> TreeBlockCard, incisedLog: () -> TreeBlockCard, sap: () -> Item, rosin: () -> Item) = this.logBase().block { { DrippingLogBlock(incisedLog, sap, rosin, it) } }.let { TreeDrippingLogBlockCard(it, log) }
