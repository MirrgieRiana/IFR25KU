...
abstract class TreeBlockCard(val configuration: TreeBlockConfiguration) {
    companion object {
        ...
        ).tag(BlockTags.SAPLINGS, ItemTags.SAPLINGS).let { TreeSaplingBlockCard(it, MirageFairy2024.identifier("haimeviska"), GIANT_HAIMEVISKA_CONFIGURED_FEATURE_KEY, SMALL_HAIMEVISKA_CONFIGURED_FEATURE_KEY) }
        ...
        ).tag(BlockTags.SAPLINGS, ItemTags.SAPLINGS).let { TreeSaplingBlockCard(it, MirageFairy2024.identifier("plastic_tree"), GIANT_HAIMEVISKA_CONFIGURED_FEATURE_KEY, SMALL_HAIMEVISKA_CONFIGURED_FEATURE_KEY) }
    }
