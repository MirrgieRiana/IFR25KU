...
private fun TreeBlockConfiguration.incisedLog(log: () -> TreeBlockCard, drippingLog: () -> TreeBlockCard) = this.logBase().block { { IncisedLogBlock(drippingLog, it) } }.let { TreeIncisedLogBlockCard(it, log) }
