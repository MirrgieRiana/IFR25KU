...
private fun TreeBlockConfiguration.drippingLog(log: () -> TreeBlockCard, sap: () -> Item) = this.logBase().block { { DrippingPlasticTreeLogBlock(it) } }.let { TreeDrippingLogBlockCard(it, log, sap) }
private fun TreeBlockConfiguration.harvestableDrippingLog(log: () -> TreeBlockCard, sap: () -> Item, rosin: () -> Item) = this.logBase().block { { DrippingHaimeviskaLogBlock(it) } }.let { TreeHarvestableDrippingLogBlockCard(it, log, sap, rosin) }
