...
import miragefairy2024.mod.tree.contents.blockcards.TreeHarvestableDrippingLogBlockCard
...
abstract class TreeBlockCard(val configuration: TreeBlockConfiguration) {
    companion object {
        ...
        ).tag(HAIMEVISKA_LOGS_BLOCK_TAG, HAIMEVISKA_LOGS_ITEM_TAG).tag(BlockTags.OVERWORLD_NATURAL_LOGS).let { TreeIncisableLogBlockCard(it) }
        ...
        ).tag(HAIMEVISKA_LOGS_BLOCK_TAG, HAIMEVISKA_LOGS_ITEM_TAG).tag(BlockTags.OVERWORLD_NATURAL_LOGS).let { TreeIncisedLogBlockCard(it, { LOG }, MapColor.RAW_IRON) }
        ...
        ).tag(HAIMEVISKA_LOGS_BLOCK_TAG, HAIMEVISKA_LOGS_ITEM_TAG).tag(BlockTags.OVERWORLD_NATURAL_LOGS).let { TreeHarvestableDrippingLogBlockCard(it, { LOG }, MaterialCard.HAIMEVISKA_SAP.item, MaterialCard.HAIMEVISKA_ROSIN.item, MapColor.RAW_IRON) }
        ...
        ).tag(HAIMEVISKA_LOGS_BLOCK_TAG, HAIMEVISKA_LOGS_ITEM_TAG).tag(BlockTags.OVERWORLD_NATURAL_LOGS).let { TreeHollowLogBlockCard(it, { LOG }, MapColor.RAW_IRON) }
        ...
        ).tag(HAIMEVISKA_LOGS_BLOCK_TAG, HAIMEVISKA_LOGS_ITEM_TAG).tag(BlockTags.OVERWORLD_NATURAL_LOGS).let { TreeDrippingLogBlockCard(it, { LOG }, MaterialCard.PLASTIC_TREE_SAP.item, MapColor.COLOR_YELLOW) }
    }
