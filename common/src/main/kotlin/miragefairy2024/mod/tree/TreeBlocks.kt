...
private fun TreeBlockConfiguration.log(block: (BlockBehaviour.Properties) -> Block) = this.logBase().block { { block(it) } }.let { TreeIncisableLogBlockCard(it) }
