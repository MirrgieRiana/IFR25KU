...
private fun TreeBlockConfiguration.incisedPlasticTreeLog() = this.logBase().block { { IncisedPlasticTreeLogBlock(it) } }.let { TreeIncisedLogBlockCard(it) }
