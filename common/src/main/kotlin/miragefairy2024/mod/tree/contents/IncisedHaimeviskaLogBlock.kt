...
class IncisedHaimeviskaLogBlock(private val drippingLog: () -> TreeBlockCard, settings: Properties) : SimpleHorizontalFacingBlock(settings) {
    companion object {
        val CODEC: MapCodec<IncisedHaimeviskaLogBlock> = RecordCodecBuilder.mapCodec { instance ->
            instance.group(
                ...
                propertiesCodec(),
            ).apply(instance, ::IncisedHaimeviskaLogBlock)
        }
    }
