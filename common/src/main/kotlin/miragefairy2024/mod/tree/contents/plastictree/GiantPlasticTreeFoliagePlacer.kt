...
object GiantPlasticTreeFoliagePlacerCard {
    ...
    private val codec: MapCodec<GiantPlasticTreeFoliagePlacer> = MapCodec.unit { GiantPlasticTreeFoliagePlacer }
    val type: FoliagePlacerType<GiantPlasticTreeFoliagePlacer> = FoliagePlacerType(codec)
}

object GiantPlasticTreeFoliagePlacer : FoliagePlacer(ConstantInt.of(3), ConstantInt.of(0)) {
