...
enum class EnchantmentCard(
    ...
    STICKY_MINING(
        ...
        ItemTags.MINING_ENCHANTABLE, NONE_ITEM_TAG, EnchantmentRarity.VERY_RARE,
        1, 25, 25, 50,
        tags = listOf(EnchantmentTags.TREASURE),
    ),
    FORWARD_AREA_MINING(
        "forward_area_mining", EnJa("Forward Area Mining", "前方範囲採掘"),
        ItemTags.MINING_ENCHANTABLE, AREA_MINING_ENCHANTABLE_ITEM_TAG, EnchantmentRarity.VERY_RARE,
        5, 25, 25, 50,
