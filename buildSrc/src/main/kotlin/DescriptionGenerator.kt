...
ハイメヴィスカ（樹木）　IFR25KU固有の樹木。原木・葉に加え、後述の樹液の供給源となる。探索・伐採で入手し、以降の加工系の起点になる。
樹液　ハイメヴィスカから得られる液体素材。各種の加工・醸造レシピの基材として扱われ、後段の精製品（涙など）に接続する。
涙　樹液を加工して得られる精製素材の総称。ユーティリティやツール、消費アイテムの素材として幅広く登場する。
醸造樽　液体系レシピを扱う加工装置。樹液の処理や飲料・抽出物の製造など、液体系クラフトのハブとして使う。
妖精の家　妖精関連の拠点ユーティリティ。設置して利用する要素で、当MODの妖精コンテンツと連動する。
ドリンク類　醸造樽で作る飲料・抽出物。探索や栽培の支援効果を持つ消費アイテム群。
紅天石　IFR25KU固有の結晶／鉱物素材。ツールや装置、ユーティリティのクラフトに用いられる基本資源。
蒼天石　紅天石と対になる結晶／鉱物素材。各種レシピの部材として登場し、段階の進行に関わる。
オーラ反射炉　オーラ反応を用いた加工装置。結晶・鉱物・専用素材の変換や精製など、上位工程で使用する。
ミラジウム　上位の専用素材。装置・ツール・ユーティリティの高段階レシピに用いられる。
