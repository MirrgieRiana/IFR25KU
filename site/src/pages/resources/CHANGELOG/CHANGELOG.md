...
- 追加: ブロック「プラノキの葉」を追加。
  - 破壊すると、稀にプラノキの苗木を落とす。
- 追加: ブロック「プラノキの苗木」を追加。
  - 1個だけ植えると小さいプラノキが、2x2に並べて植えると大きいプラノキが育つ。
...
- 追加: ブロック「樹液が滴るプラノキの原木」を追加。
  ...
  - 右クリックでプラノキの樹液を収穫できる。
    ...
    - 3%の確率で、追加でハイメヴィスカの涙が出る。
      - 幸運1につき確率が1%増える。
  - 回収時、シルクタッチが無い限りプラノキの原木に化ける。
  - 回収時、追加でプラノキの樹液が出る。
  - 回収時、1%の確率で追加でハイメヴィスカの涙が出る。
- 追加: 樹木「プラノキ」を追加。
  - 大きいものと小さいものの2種類がある。
  - 大きいものは幹が2x2の太さで、そこから四方に伸びる枝の先に葉が付く。
  - 小さいものは幹が1x1の太さで、枝を持たない。
  - 葉はまばらで、枝や葉の向きは規則性を持たない。
  - ツタは生えない。
...
- 変更: 琥珀色の原生林に生成される木が、タイガの木からプラノキに変わった。
  - 大きいものと小さいものが同じ頻度で生成される。
