...
- 追加: ブロック「石化した樹脂状の土」を追加。
  ...
  - 採掘には石以上のツルハシが必要。
- 追加: 鉱石ブロック「石化した樹脂状の土レチナイト鉱石」を追加。
  - 琥珀色の原生林のY48～127の石化した樹脂状の土に低確率で生成。
- 追加: 鉱石ブロック「石化した樹脂状の土妖精のプラスチック鉱石」を追加。
  - 琥珀色の原生林のY48～127の石化した樹脂状の土に低確率で生成。
- 追加: 鉱石ブロック「石化した樹脂状の土コーパル鉱石」を追加。
  - 琥珀色の原生林のY48～127の石化した樹脂状の土に低確率で生成。
- 追加: 装飾ブロック「石化した樹脂状の土レンガ」を追加。
  - クラフトおよび石切台で入手可能。
- 追加: 装飾ブロック「石化した樹脂状の土レンガのハーフブロック」を追加。
  - クラフトおよび石切台で入手可能。
- 追加: 装飾ブロック「石化した樹脂状の土レンガの階段」を追加。
  - クラフトおよび石切台で入手可能。
...
- 追加: 木「プラノキ」を追加。
  ...
  - 琥珀色の原生林の石化した樹脂状の土の上に、大きい木1本につき小さい木2本の割合で生成される。
...
- 追加: 石化した樹脂状の土から土とプラノキの樹液とレチナイトとコーパルを作るアタノールレシピを追加。
...
- 追加: 全画面版フェアリークエストカードに「ゲームへ戻る」ボタンと「戻る」ボタンを追加。
- 表示: 全画面版フェアリークエストカードのレイアウトが変わった。
- 表示: 全画面版フェアリークエストカードのスクロールバーの色を黒系に変更。
