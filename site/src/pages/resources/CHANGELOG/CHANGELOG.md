...
- 変更: ハイメヴィスカの幹が2x2の太さになった。
  - 苗木を2x2に並べて植えると、これが育つ。
- 変更: ハイメヴィスカの葉が、幹から螺旋を描くように伸びる枝の先に付くようになった。
- 変更: 平原・森林バイオームでのハイメヴィスカの生成頻度を半分に減少。
  - 減らした分は小型のハイメヴィスカの生成に割り当てられている。
- 変更: 土妖精のプラスチック鉱石が、草ブロックやポドゾルなどではなく、土ブロックのみに生成されるようになった。
...
- 変更: 大鎌の範囲収穫が、ブロックに遮られた先には届かなくなった。
...
- 修正: 共通機械レシピのレシピビューワーの出力にレシピリマインダーも含めるようにした。
