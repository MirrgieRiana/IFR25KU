...
{% paper_photo "message-reception-diagram.webp" "メッセージの受信の概念図" %}
...
{% paper_photo "parallel-universe-collection.webp" "並行宇宙での文献採集計画" %}
...
受信衛星は次回の信号の受信が初の任務となるため、大きな期待が寄せられている。
...
{% paper_photo "deep-space-stars.webp" %}
