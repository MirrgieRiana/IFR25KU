...
{% paper_figure "tall-green-creature.webp" "図１　 非人型で緑色で縦長の奇形生物" %}
...
{% paper_subsection %}2-1 形態{% endpaper_subsection %}
...
{% paper_figure actual_size "incident-map.webp" %}
...
{% paper_figure "warehouse-outbreak.webp" "図２　奇形生物の発生した倉庫" %}
