...
layout: theater
header:
  teaser: /assets/images/2026/04/13/magnetite-pickaxe/narrow-cave.webp
...
![]({{ "/assets/images/2026/04/13/magnetite-pickaxe/iron-ore.png" | relative_url }})
{% say tsumugi3:まゆ=困り眉 %}最悪……口の中までじゃりじゃりする……{% endsay %}

{% space %}

![]({{ "/assets/images/2026/04/13/magnetite-pickaxe/cave-entrance.webp" | relative_url }})
{% say empty:gray %}コツ コツ コツ コツ（採掘の音）{% endsay %}
{% say tsumugi3:まゆ=困り眉 %}ただいまー……{% endsay %}
{% say zundamon23 %}つむぎ？すごい顔になってるのだ。{% endsay %}
{% say tsumugi3:まゆ=困り眉 %}分かってる……{% endsay %}
{% say zundamon23 %}お疲れ様なのだ。{% endsay %}
{% say empty:gray %}コツ コツ コツ コツ（採掘の音）{% endsay %}
{% say tsumugi3:口=わあ %}……ん？ねえ、センパイが掘ったやつ、勝手にそっちに飛んでってない？{% endsay %}
![]({{ "/assets/images/2026/04/13/magnetite-pickaxe/magnetite-pickaxe.png" | relative_url }})
...
![]({{ "/assets/images/2026/04/13/magnetite-pickaxe/dark-cave-torches.webp" | relative_url }})
...
{% say zundamon23 %}奥の方はまだ暗くて危ないのだ。{% endsay %}
{% say tsumugi3 %}わーってるって！{% endsay %}

{% space %}

{% say tsumugi3:口=わあーい %}センパーイ！見て！！洞窟ぐるっと回っちゃった！めっちゃサクサク取れた！{% endsay %}
![]({{ "/assets/images/2026/04/13/magnetite-pickaxe/mining-loot.png" | relative_url }})
...
![]({{ "/assets/images/2026/04/13/magnetite-pickaxe/lava-pool.webp" | relative_url }})
...
{% say tsumugi3 %}磁鉄鉱なら溶岩の上でも関係ないもんね！{% endsay %}
{% say tsumugi3 %}いっくよー！{% endsay %}
{% say tsumugi3:まゆ=困り眉 %}……あれ？全然掘れない……{% endsay %}
{% say tsumugi3 %}えいっ！えいっ！{% endsay %}
{% say tsumugi3 %}……！？{% endsay %}
{% say tsumugi3 %}何も出なかった！？{% endsay %}
{% say zundamon23 %}……ダイヤは磁鉄鉱じゃ硬すぎて歯が立たないのだ。{% endsay %}
{% say tsumugi3:まゆ=困り眉 %}……そんなーーー！！！{% endsay %}
