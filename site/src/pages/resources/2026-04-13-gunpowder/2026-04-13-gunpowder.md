...
layout: theater
header:
  teaser: /assets/images/2026/04/13/gunpowder/cave-mining-site.webp
...
![]({{ "/assets/images/2026/04/13/gunpowder/mining-haul.png" | relative_url }})
{% say tsumugi3 %}ほら、全部掘ってきた。{% endsay %}
{% say zundamon23 %}豊作なのだ。{% endsay %}
{% say tsumugi3 %}もう腕も足もインベントリもパンパン……{% endsay %}
![]({{ "/assets/images/2026/04/13/gunpowder/athanor.webp" | relative_url }})
...
![]({{ "/assets/images/2026/04/13/gunpowder/recipe-tnt.png" | relative_url }})
...
![]({{ "/assets/images/2026/04/13/gunpowder/recipe-charcoal.png" | relative_url }})
{% say tsumugi3 %}……ねえ、今入れたのってハイメヴィスカの木じゃないの？{% endsay %}
{% say zundamon23 %}なのだ。火薬には炭がいるのだ。{% endsay %}
![]({{ "/assets/images/2026/04/13/gunpowder/recipe-gunpowder.png" | relative_url }})
{% say tsumugi3 %}えーっ！！伐採して炭にしちゃうの？木だって生きてるんでしょ？{% endsay %}
{% say tsumugi3 %}木を炭にしちゃうなんてかわいそうだよ！{% endsay %}
{% say tsumugi3 %}あーし石炭の火薬がいい！！{% endsay %}
{% say zundamon23 %}石炭だって昔は木だったのだ。{% endsay %}
{% say tsumugi3 %}でももう死んでる木じゃん！{% endsay %}

{% space %}

{% say tsumugi3 %}よーし！これ全部粉にしてやる！！！{% endsay %}
![]({{ "/assets/images/2026/04/13/gunpowder/coal-grinding.png" | relative_url }})
{% say tsumugi3:まゆ=困り眉 %}――固っ！全然削れないんだけど！{% endsay %}
{% say zundamon23 %}こっちはもう半分終わったのだ。{% endsay %}
{% say tsumugi3 %}えっ！？早っ！！ちょっと待って！{% endsay %}
{% say zundamon23 %}木炭は手で割れるのだ。{% endsay %}
{% say tsumugi3 %}むー！負けないもんね！{% endsay %}

{% space %}

{% say tsumugi3:口=わあーい %}できたあああっっ！！！{% endsay %}
![]({{ "/assets/images/2026/04/13/gunpowder/gunpowder-from-coal.png" | relative_url }})
{% say tsumugi3:口=わあーい %}どうどう！？あーしの火薬！！比べてみて！めっちゃサラサラでしょ！？{% endsay %}
![]({{ "/assets/images/2026/04/13/gunpowder/gunpowder-comparison.png" | relative_url }})
...
![]({{ "/assets/images/2026/04/13/gunpowder/torches-stock.png" | relative_url }})
{% say tsumugi3 %}…………{% endsay %}
