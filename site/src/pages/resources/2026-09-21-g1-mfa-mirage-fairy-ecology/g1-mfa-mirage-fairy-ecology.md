...
{% paper_section %}能力{% endpaper_section %}

{% paper_subsection %}超能力{% endpaper_subsection %}
...
{% paper_subsection %}言語{% endpaper_subsection %}
...
{% paper_subsection %}捕獲{% endpaper_subsection %}
...
{% paper_subsection %}翅{% endpaper_subsection %}
...
{% paper_subsection %}触角{% endpaper_subsection %}
...
{% paper_subsection %}触手{% endpaper_subsection %}
...
{% paper_subsection %}栄養{% endpaper_subsection %}
...
{% paper_subsection %}衣服{% endpaper_subsection %}
